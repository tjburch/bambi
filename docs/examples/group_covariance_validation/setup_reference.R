...
versions <- c(posterior = "1.6.1", loo = "2.8.0", bayesplot = "1.13.0",
              jsonlite = "2.0.0", StanHeaders = "2.32.10",
...
for (package in names(versions)) {
  ...
  if (!has_version(package, version)) {
    stop("Reference package version mismatch: ", package, "; expected ", version,
